...
## Repo state on setup (2026-05-20)

Of the five labels above, only `wontfix` already exists on `Cereal-Automation/desktop-client`. The triage skill should create the other four on first use via:
