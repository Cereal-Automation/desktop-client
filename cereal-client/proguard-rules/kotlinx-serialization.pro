# Taken from https://github.com/Kotlin/kotlinx.serialization/blob/master/rules/common.pro
...
# Custom rules below to keep generated serializable models.

# Keep all serializer classes (including obfuscated ones)
