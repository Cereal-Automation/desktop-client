...
/**
 * Code taken from https://github.com/JetBrains/compose-multiplatform-core/pull/1457.
 */
...
@Composable
internal fun rememberBitmapResource(path: String): Painter = remember(path) { BitmapPainter(readResourceBytes(path).decodeToImageBitmap()) }
